...
class ModelWrapper:
    ...
    def generate_image(
        ...
        if nsfw_score < NSFW_THRESHOLD:
            ...
            prompt_clean = "".join(c if c.isalnum() else '_' for c in prompt)[:50].rstrip()
            filename = f"output/{now}_{prompt_clean}_{seed}.jpg"
            # filename = f"output/{uuid.uuid4()}.jpg"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--width", type=int, default=1360, help="Image width")
